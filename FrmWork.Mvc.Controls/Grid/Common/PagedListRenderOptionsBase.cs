...
namespace FrmWork.Mvc.Controls.Grid.Common
{
    public class PagedListRenderOptionsBase
    {
        ...
        public PagedListRenderOptionsBase()
        {
            ...
            PageCountAndCurrentLocationFormat = Grid.Resources.Grid.txt_PageXFromYFormat;
            ItemSliceAndTotalFormat = Grid.Resources.Grid.txt_ShowingItemsXthroughYofX;
        ...
        public static PagedListRenderOptionsBase TwitterBootstrapPager
        {
            get
            {
                return new PagedListRenderOptionsBase
                {
                    ...
                    ClassToApplyToFirstListItemInPager = null,
                    ClassToApplyToLastListItemInPager = null,
                    LinkToPreviousPageFormat = Grid.Resources.Grid.txt_Previous,
                    LinkToNextPageFormat = Grid.Resources.Grid.txt_Next
                };
            }
        }
